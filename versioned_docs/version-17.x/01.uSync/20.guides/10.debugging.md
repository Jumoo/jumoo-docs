...
Logging in Umbraco 17 is managed via [Serilog](https://docs.umbraco.com/umbraco-cms/fundamentals/code/debugging/logging) which outputs all logging messages to files in the `App_Data/Logs` folder.
