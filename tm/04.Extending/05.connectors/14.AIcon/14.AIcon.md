...
![The OpenAI connector options, including the OpenAI API Key box. ](transSettingsAI.png)
...
# Displaying AI Connectors

The AI connector allows you to connect to various AI translation connectors in one place. However, if you want to work with a connector individually, they are available in the settings sidebar under connectors.

If you do not want to see these individual connector pages in the sidebar, you can hide them by setting this setting to single:

```json
 "Translations": {
    "AI": {
      "ConnectorMode": "All|Individual|Single"
    }
  }
```