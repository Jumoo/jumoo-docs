...
There is a batch mode it batches the mode and allows you to batch modes 

![batchh](BatchModeOption.png)

batch mode batches your translation, it can/will/does take 24 hours for it to become something bnecause its batched

you also have a list of the possible connectors now to stare at and think "woahhh. ai is a thing". you can turn this off if you dont care. 
