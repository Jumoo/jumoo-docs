...
:::note
Translation Manager v18 runs on Umbraco v18
::: 
...
```cli
<PackageReference Include="Jumoo.TranslationManager" Version="18.*" />
```
...
## Install as Package 
On Umbraco v18 you can't install packages via the backoffice, it must be installed via NuGet.
