...
3. The order of notifications cannot be guaranteed. Save events may be triggered after publish events. If your notifications are sensitive to the ordering of notification events you should not use the background notification setting.
