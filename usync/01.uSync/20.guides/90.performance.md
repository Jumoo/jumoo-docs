...
## Import Caching
If you enable the [`CacheImportState`](cache) setting, uSync will create an identifier to tell it if a file has been changed, rather than checking the whole file on import or report. This speeds things up for large sites with 10,000+ pieces of content.
