...
:::note
uSync v18 runs on Umbraco v18.x. See our [compatibility table](/SupportLifecycles) to see which version you need for other Umbraco versions. 
:::
...
### Install as Package
:::info
uSync v18 is only available as a NuGet package, there is currently no way to install a package directly from the backoffice in Umbraco 18
:::
