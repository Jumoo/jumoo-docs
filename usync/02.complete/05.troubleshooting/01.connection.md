...
If push or pull operations fail partway through with a 'File not found' or 'Folder missing'
error, your site is probably load balanced - see the dedicated [Load Balancing](load-balancing)
page for why this happens and how to fix it.
