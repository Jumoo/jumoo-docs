...
[Load Balancing](../../../troubleshooting/connection#1-load-balancing) for when you might
want this off.
...
default - see [Load Balancing](../../../troubleshooting/connection#1-load-balancing) for
the full picture.
