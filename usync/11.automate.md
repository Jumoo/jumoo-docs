...
```html
dotnet add package uSync.Automate
```

```html
dotnet add package uSync.Automate.Actions
```
...
```html
dotnet add package uSync.Automate.Actions.Complete
```
...
![A push process in an automated workspace.](automatedPush17.png)
